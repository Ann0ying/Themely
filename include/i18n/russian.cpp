...
std::map<std::string, std::wstring> RUSSIAN = {
	...
	{"fullscreen_prev",     L"Полноэкранный предпросмотр"},
	{"hold_delete",         L"[Удерживать] Удаление"},
	...
	{"qr_explain_3",        L"Перейдите на 3DSThem.es, Выбирите тему, затем нажмите на"},
	{"qr_explain_4",        L"кнопку QR-кода чтобы увидеть QR-код этой темы"},
